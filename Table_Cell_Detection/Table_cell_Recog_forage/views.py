...
class PyMuPdf:
    ...
    def pdf_to_page_df_mypypdf_intrim(self, page_num, result_save):
        ...
        if word:
            ...
            # dataframe.to_json(self.result_dir + str(page_num)+'_df_before_processing.json')
            ...
            undet_img = self.get_undetected_parts_img(image_name, table_list, page_num, save_img=False)

            # fill dataframe with overlap information of table and cells
            ...
            dataframe, self.lookup_detections_df = self.get_undetected_parts_bbox(input_df=dataframe,
                                                                                  det_df=self.lookup_detections_df,
            ...
            # self.lookup_detections_df.to_json(self.result_dir + str(page_num) + '_det_frame_2_undetected_info.json')
    ...
    def post(self, request):
        ...
        try:
            ...
            _,_,_,_,result = Obj.pdf_to_page_df_2(pdfpath=file_path, UID=sid,
                                          ...
                                          save_result_dir='pdf_to_excel_output/'
                                          )
...
#pdf_file_path = r'D:\ForageAI\dataset\test_images_source/test_pdf2.pdf'
#page_info, final_df, final_df_raw = obj.pdf_to_page_df_2(pdfpath=pdf_file_path, UID='1', page_list=[55, 56, 57], save_result_dir='pdf_excel_result/')
